 ...
 * @author lele
 */
public abstract class PersonagemQueLuta extends PersonagemComInventario {

    private int ataque;
    private int defesa;
    private float energia;
    private int max_energia;
    private final int valor_maximo_atributos;
    private AttackWeapon Attack_Weapon;
    private DefenseWeapon Shield;

    public PersonagemQueLuta(int ataque, int defesa, int energia, float carregar) {
        super(carregar);
        this.ataque = ataque;
        this.defesa = defesa;
    ...
    public void equipAttackWeapon(AttackWeapon w) {
    ...
    public void equipShield(DefenseWeapon w) {
        this.Shield = w;
        w.addModificador(this);
    }
